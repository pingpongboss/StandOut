...
* 
* Contributors:
* - Jesús Gulfo <jedga_95@outlook.com>
* 
*/
public abstract class StandOutWindow extends Service {
    ...
    public static class StandOutFlags {
        ...
        /**
          * If {@link #FLAG_DECORATION_SYSTEM} is set, setting this flag
          * indicates that the window decorator should NOT provide a touch
          * listener to the title bar.
          * 
          * <p>
          * This flag also sets {@link #FLAG_DECORATION_SYSTEM}.
          */
        ...
        /**
          ...
          * 
          * @see StandOutWindow.Window#onFocus(boolean)
          * 
          */
        ...
        /**
          ...
          * {@link StandOutWindow.Window#fixCompatibility(View)} on the view
          * returned by the implementation.
          * 
          * @see StandOutWindow.Window#fixCompatibility(View)
          *
          */
        ...
        /**
          ...
          * {@link StandOutWindow.Window#addFunctionality(View)} on the view
          * returned by the implementation.
          * 
          * @see StandOutWindow.Window#addFunctionality(View)
          */
    ...
    public static void show(Context context,
        ...
        show(context, cls, null, id);
    }
    
    /**
      * Allows to show a new window, passing Bundles before of creation
      * 
      * @param context
      *            A Context of the application package implementing this class.
      * @param cls
      ...
      *            will be restored.
      * 
      * @see #show(context, Class<? extends StandOutWindow>,int)
      */
    public static void show(Context context,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if(DEBUG) Log.w(TAG, "Tried to onStartCommand() with a null intent.");
        }
    ...
    /**
      ...
      * want more control over the popup menu.
      * 
      * <p>
      * Implement this method to set a custom popup menu when the user clicks
      ...
      */
    protected PopupMenu getPopupMenu(final int id, View view) {
    ...
    /**
      ...
      * @return The {@link PopupMenu} to be shown.
      */
    protected PopupMenu getPopupMenuItems(int id, View view) {
        return null;
    }
    ...
    /**
      ...
      * @param event
      *            See linked method.
      * @see #onTouchHandleMove(int, Window, View, MotionEvent)}
      */
    ...
    /**
      ...
      * @param event
      *            See linked method.
      * @see #onTouchHandleResize(int, Window, View, MotionEvent)}
      */
    ...
    /**
      ...
      * @see Window#dispatchKeyEvent(KeyEvent)}
      */
    ...
    protected final synchronized Window show(int id) {
        ...
        if (onShow(id, window)) {
            if(DEBUG) Log.d(TAG, "Window " + id + " show cancelled by implementation.");
            return null;
        }
    ...
    protected final synchronized void hide(int id) {
        ...
        // alert callbacks and cancel if instructed
        if (onHide(id, window)) {
            if(DEBUG) Log.w(TAG, "Window " + id + " hide cancelled by implementation.");
            return;
        }
    ...
    protected final synchronized void close(final int id) {
        ...
        if (onClose(id, window)) {
            if(DEBUG) Log.w(TAG, "Window " + id + " close cancelled by implementation.");
            return;
        }
    ...
    protected final synchronized void closeAll() {
        // alert callbacks and cancel if instructed
        if (onCloseAll()) {
            if(DEBUG) Log.w(TAG, "Windows close all cancelled by implementation.");
            return;
        }
    ...
    protected final void setIcon(int id, int drawableRes) {
        Window window = getWindow(id);
        if (window != null) {
            ImageView icon = (ImageView) window.findViewById(R.id.window_icon);
            if (icon != null) {
    ...
    private void updateViewLayout(int id, LayoutParams params) {
        ...
        if (onUpdate(id, window, params)) {
            if(DEBUG) Log.w(TAG, "Window " + id + " update cancelled by implementation.");
            return;
        }
    ...
    public class Window extends FrameLayout {
        ...
        /**
          ...
          */
        private StandOutWindow.LayoutParams originalParams;
        ...
        public boolean onInterceptTouchEvent(MotionEvent event) {
            ...
            // multitouch
            if (event.getPointerCount() >= 2 && Utils.isSet(flags,
            ...
            if (event.getPointerCount() >= 2 && Utils.isSet(flags,
                ...
                switch (event.getAction() & MotionEvent.ACTION_MASK) {
                    case MotionEvent.ACTION_MOVE:
                        ...
                        edit().setAnchorPoint(.5f, .5f).setSize(
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
                if (onKeyEvent(id, this, event)) {
                    if(DEBUG) Log.d(TAG, "Window " + id + " key event " + event
        ...
        public boolean onFocus(boolean focus) {
            if (!Utils.isSet(flags, StandOutFlags.FLAG_WINDOW_FOCUSABLE_DISABLE)) {
                ...
                if (context.onFocusChange(id, this, focus)) {
                    if(DEBUG) Log.d(TAG, "Window " + id + " focus change "
                            + (focus ? "(true)" : "(false)")
                            + " cancelled by implementation.");
                    focused = !focus;
                    return false;
        ...
        */
        ...
        private View getSystemDecorations() {
            ...
            // move
            LinearLayout titlebar = (LinearLayout) decorations.findViewById(R.id.titlebar);
            ...
            */
            ...
            public String toString() {
                return String.format(
                        "WindowTouchInfo { firstX=%d, firstY=%d,lastX=%d,"
                        + " lastY=%d, firstWidth=%d, firstHeight=%d }",                 
        ...
        public class Editor {
            ...
            public Editor() {
                ...
                displayHeight = (int) (metrics.heightPixels - 25 * 
                        metrics.density);
            }
                ...
                if (mParams != null) {
                    if (anchorX < 0 || anchorX > 1 || anchorY < 0
                        ...
                        throw new IllegalStateException(
                                "Anchor point must be between 0 and 1, "
                                + "inclusive.");
                    }
                    ...
                    if (Utils.isSet(flags,
                        ...
                        int ratioWidth = (int) (mParams.height *
                                touchInfo.ratio);
                        int ratioHeight = (int) (mParams.width /
                                touchInfo.ratio);
                ...
                if (mParams != null) {
                    ...
                    if (Utils.isSet(flags,
                        ...
                        if (mParams.gravity != (Gravity.TOP | Gravity.LEFT)) {
                            throw new IllegalStateException(
                                    "The window " + id
                                    + " gravity must be TOP|LEFT if "
                                    + "FLAG_WINDOW_EDGE_LIMITS_ENABLE or "
